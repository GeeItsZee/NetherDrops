...
/**
 * Created by Trace Bachi (BigBossZee) on 7/14/2015.
 */
public class DropableItemStack
{
    private final ItemStack itemStack;
    private final int maxAmount;
    private final double probability;

    public DropableItemStack(ItemStack itemStack, double probability, int maxAmount)
    {
